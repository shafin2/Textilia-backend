...
const blockBookingProposalController = require("../controllers/blockBookingProposal.controller");
const { protect } = require("../middleware/auth.middleware");

router.post("/create", protect(["supplier"]), blockBookingProposalController.createProposal);

router.get("/customer", protect(["client"]), blockBookingProposalController.getCustomerProposals);
...
router.post("/proposal/:proposalId/accept", protect(["client"]), blockBookingProposalController.acceptProposal);
